<script lang="ts">
  ...
  const rows: { keys: string[]; label: "shortcuts.newSpending" | "shortcuts.newIncome" | "shortcuts.newCategory" | "shortcuts.search" | "shortcuts.print" | "shortcuts.palette" | "shortcuts.saveAndNext" | "shortcuts.clear" | "shortcuts.help" }[] = [
    ...
    { keys: ["Ctrl + Enter"], label: "shortcuts.saveAndNext" },
