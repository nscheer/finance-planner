...
export const en = {
  ...
  "app.retry": "Retry",
  "app.data": "Data",
  "app.dataMenu": "Import, export and backups",
  "app.import": "Import",
  "app.export": "Export",
  ...
  "status.pathCopyFailed": "The path could not be copied.",
  "status.categories.one": "{count} category",
  "status.categories.other": "{count} categories",
  "status.entries.one": "{count} entry",
  "status.entries.other": "{count} entries",
